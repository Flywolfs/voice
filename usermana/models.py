...
class ManaplatformGroup(models.Model):
    token = models.CharField(max_length=255)
    create_time = models.DateTimeField()

    class Meta:
        managed = False
        db_table = 'manaplatform_group'


class ManaplatformMember(models.Model):
    member_name = models.CharField(max_length=255)
    member_id = models.CharField(max_length=255)
    role = models.CharField(max_length=255)
    create_time = models.DateTimeField()
    group = models.ForeignKey(ManaplatformGroup, models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'manaplatform_member'


class ManaplatformUser(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'manaplatform_user'


class ManaplatformUserLogin(models.Model):
    username = models.CharField(max_length=255)
    last_login_time = models.DateTimeField()
    login_token = models.CharField(max_length=255)
    user = models.ForeignKey(ManaplatformUser, models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'manaplatform_user_login'
